...
window.GAME_RE = [
  ...
  [/^胜利奖励 ≈ (.+?) ELEM（按英雄星级\/等级加成，存入金库待领取）$/, m => 'Win reward ≈ ' + m[1] + ' ELEM (hero bonus, stored in vault)'],
  ...
  [/^奖励基数 ×0.01 = 基础 ELEM（≈(.+?) ELEM，英雄加成后更高）$/, m => 'Reward base ×0.01 = base ELEM (≈' + m[1] + ' ELEM, higher with hero bonus)'],
